...
class Ui_Fornecedor(object):
    def setupUi(self, Fornecedor):
        ...
        Fornecedor.resize(900, 724)
        Fornecedor.setMinimumSize(QSize(900, 700))
        Fornecedor.setStyleSheet(u"QWidget{\n"
"	background-color: rgb(236, 242, 248);\n"
"}\n"
"")
        self.gridLayout = QGridLayout(Fornecedor)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(30, 30, 30, 30)
        self.stackedWidget = QStackedWidget(Fornecedor)
...
"}")
    ...
    def retranslateUi(self, Fornecedor):
        ...
        self.label_3.setText(QCoreApplication.translate("Fornecedor", u"Cadastrar Novo Fornecedor", None))
        self.label_25.setText(QCoreApplication.translate("Fornecedor", u"Inscri\u00e7\u00e3o Estadual", None))
        self.input_inscricaoEstadual.setPlaceholderText("")
        self.label_26.setText(QCoreApplication.translate("Fornecedor", u"Email", None))
        self.label_24.setText(QCoreApplication.translate("Fornecedor", u"CPF/CNPJ", None))
        self.input_cpf.setPlaceholderText("")
        self.label_38.setText(QCoreApplication.translate("Fornecedor", u"Endere\u00e7o", None))
        self.label_28.setText(QCoreApplication.translate("Fornecedor", u"Complemento", None))
        self.label_40.setText(QCoreApplication.translate("Fornecedor", u"CEP", None))
        self.label_41.setText(QCoreApplication.translate("Fornecedor", u"Cidade", None))
        self.label_37.setText(QCoreApplication.translate("Fornecedor", u"UF", None))
        self.label_42.setText(QCoreApplication.translate("Fornecedor", u"Bairro", None))
        self.label_33.setText(QCoreApplication.translate("Fornecedor", u"Observa\u00e7\u00e3o", None))
        self.label_32.setText(QCoreApplication.translate("Fornecedor", u"Nome", None))
        self.input_nome.setPlaceholderText("")
        self.label_31.setText(QCoreApplication.translate("Fornecedor", u"Celular", None))
        self.input_celular.setText("")
        self.label_30.setText(QCoreApplication.translate("Fornecedor", u"Telefone", None))
        self.input_telefone.setText("")
        self.input_telefone.setPlaceholderText("")
        self.btn_salvar.setText(QCoreApplication.translate("Fornecedor", u"Salvar", None))
        self.btn_consulta.setText(QCoreApplication.translate("Fornecedor", u"Consultar", None))
        self.btn_novo.setText(QCoreApplication.translate("Fornecedor", u"Novo", None))
    # retranslateUi
