...
################################################################################
## Form generated from reading UI file 'cliente_editarXYTSlK.ui'
##
...
class Ui_ClienteEdit(object):
    def setupUi(self, ClienteEdit):
        if not ClienteEdit.objectName():
            ClienteEdit.setObjectName(u"ClienteEdit")
        ClienteEdit.resize(900, 700)
        ClienteEdit.setMinimumSize(QSize(900, 700))
        ClienteEdit.setStyleSheet(u"QWidget{\n"
"	background-color: rgb(236, 242, 248);\n"
"}\n"
"")
        self.gridLayout = QGridLayout(ClienteEdit)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(30, 30, 30, 30)
        self.frame_5 = QFrame(ClienteEdit)
        ...
        self.frame_8 = QFrame(ClienteEdit)
...
"}")
        ...
        self.frame_29.setMaximumSize(QSize(150, 70))
        ...
        self.input_nascimento = QDateEdit(self.frame_29)
        self.input_nascimento.setObjectName(u"input_nascimento")
        self.input_nascimento.setMinimumSize(QSize(0, 30))
        self.input_nascimento.setMaximumSize(QSize(16777215, 30))
        self.input_nascimento.setStyleSheet(u"QDateEdit {\n"
...
"}")
        ...
        self.frame_32.setMaximumSize(QSize(150, 70))
...
"}")
        ...
        self.frame_33.setMaximumSize(QSize(200, 70))
...
"}")
        ...
        self.frame_49.setMinimumSize(QSize(150, 0))
...
"}")
        ...
        self.gridLayout_42.addItem(self.horizontalSpacer_8, 1, 1, 1, 1)
...
"}")
        ...
        self.frame_40.setMinimumSize(QSize(200, 0))
        ...
        self.input_celular.setMaximumSize(QSize(200, 30))
...
"}")
        ...
        self.frame_38.setMaximumSize(QSize(200, 70))
        ...
        self.input_telefone.setMaximumSize(QSize(200, 30))
...
"}")
        ...
        self.retranslateUi(ClienteEdit)

        QMetaObject.connectSlotsByName(ClienteEdit)
    # setupUi

    def retranslateUi(self, ClienteEdit):
        ClienteEdit.setWindowTitle(QCoreApplication.translate("ClienteEdit", u"Form", None))
        self.label_3.setText(QCoreApplication.translate("ClienteEdit", u"Editar Cliente", None))
        self.btn_salvar.setText(QCoreApplication.translate("ClienteEdit", u"Salvar", None))
        self.label_22.setText(QCoreApplication.translate("ClienteEdit", u"Data Nascimento", None))
        self.label_25.setText(QCoreApplication.translate("ClienteEdit", u"Inscri\u00e7\u00e3o Estadual", None))
        self.label_24.setText(QCoreApplication.translate("ClienteEdit", u"CPF/CNPJ", None))
        self.label_26.setText(QCoreApplication.translate("ClienteEdit", u"Email", None))
        self.label_38.setText(QCoreApplication.translate("ClienteEdit", u"Endere\u00e7o", None))
        self.label_28.setText(QCoreApplication.translate("ClienteEdit", u"Complemento", None))
        self.label_40.setText(QCoreApplication.translate("ClienteEdit", u"CEP", None))
        self.label_41.setText(QCoreApplication.translate("ClienteEdit", u"Cidade", None))
        self.label_37.setText(QCoreApplication.translate("ClienteEdit", u"UF", None))
        self.label_42.setText(QCoreApplication.translate("ClienteEdit", u"Bairro", None))
        self.label_33.setText(QCoreApplication.translate("ClienteEdit", u"Observa\u00e7\u00e3o", None))
        self.label_32.setText(QCoreApplication.translate("ClienteEdit", u"Nome", None))
        self.label_31.setText(QCoreApplication.translate("ClienteEdit", u"Celular", None))
        self.label_30.setText(QCoreApplication.translate("ClienteEdit", u"Telefone", None))
