...
################################################################################
## Form generated from reading UI file 'usuario_editFrwzgi.ui'
##
...
class Ui_UsuarioEditar(object):
    def setupUi(self, UsuarioEditar):
        if not UsuarioEditar.objectName():
            UsuarioEditar.setObjectName(u"UsuarioEditar")
        UsuarioEditar.resize(480, 510)
        UsuarioEditar.setMinimumSize(QSize(480, 510))
        UsuarioEditar.setMaximumSize(QSize(480, 510))
        UsuarioEditar.setStyleSheet(u"QWidget{\n"
"	background-color: rgb(236, 242, 248);\n"
"}\n"
"")
        self.gridLayout = QGridLayout(UsuarioEditar)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(30, -1, 30, -1)
        self.frame_7 = QFrame(UsuarioEditar)
...
"}")
        ...
        self.label_3 = QLabel(UsuarioEditar)
        ...
        self.retranslateUi(UsuarioEditar)

        QMetaObject.connectSlotsByName(UsuarioEditar)
    # setupUi

    def retranslateUi(self, UsuarioEditar):
        UsuarioEditar.setWindowTitle(QCoreApplication.translate("UsuarioEditar", u"Form", None))
        self.label_33.setText(QCoreApplication.translate("UsuarioEditar", u"Usuario", None))
        self.label_34.setText(QCoreApplication.translate("UsuarioEditar", u"Senha", None))
        self.label_37.setText(QCoreApplication.translate("UsuarioEditar", u"Confirmar Senha", None))
        self.label_32.setText(QCoreApplication.translate("UsuarioEditar", u"Nome", None))
        self.label_35.setText(QCoreApplication.translate("UsuarioEditar", u"Sobrenome", None))
        self.label_10.setText(QCoreApplication.translate("UsuarioEditar", u"Tipo", None))
        self.input_tipo.setItemText(0, "")
        self.input_tipo.setItemText(1, QCoreApplication.translate("UsuarioEditar", u"USUARIO", None))
        self.input_tipo.setItemText(2, QCoreApplication.translate("UsuarioEditar", u"ADMINISTRADOR", None))

        self.btn_salvar.setText(QCoreApplication.translate("UsuarioEditar", u"Salvar", None))
        self.label_3.setText(QCoreApplication.translate("UsuarioEditar", u"Editar Usuario", None))
    # retranslateUi
